...
#RandAugment
parser.add_argument('--rand_augment', default=False, type=bool, help='Cutmix flag')
parser.add_argument('--n', default=10, type=int, help='n value for RandAugment')
...
def main():
    ...
    if(args.rand_augment):
        ...
        transform_train.transforms.insert(0,torchvision.transforms.RandAugment(args.n, args.m))
...
def train(trainloader, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        if(args.mixup):prec1=mixup_train_acc
